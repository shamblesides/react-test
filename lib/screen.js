...
export function screen({ scale='auto', width=null, height=null, backgroundColor='#000000', ...extraCanvasProps }) {
    const canvas = document.createElement('canvas');
    const ctx = canvas.getContext('2d', { alpha: false });
    const canvasProps = { width, height, className: 'cancan', ...extraCanvasProps };
