...
const getCompositeImage = memoizeBy([([s]) => s.sprites], function getCompositeImage({ sprites, width, height }) {
...
const readyToDrawComposite = memoize(function readyToDrawComposite(sprite) {
