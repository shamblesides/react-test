...
const InnerScreen = ({ sprites, scale='auto', width=null, height=null, showOverflow=false, hostHeight, hostWidth, backgroundColor=null }) => {
    // no area = no render
...
export const Screen = (props) => (
    ...
    <InnerScreen {...props} hostHeight={300} hostWidth={300} />
    // )}/>
);
